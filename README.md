...
- 5.65 kg project gross-mass cap
- Boulder site elevation approximated as 1655 m MSL
- 2 m AGL operating height
- 0.5 m/s maximum steady flight speed
- 15 minute endurance sizing case
- vehicle drag neglected
- Thin Electric APC propeller family only
- RPM factor of safety = 1.5
- motor + ESC + wiring efficiency = 0.80
